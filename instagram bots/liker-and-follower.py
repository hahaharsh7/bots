...
class InstaBot:
    def __init__(self,username,password):
        ...
        self.bot = webdriver.Chrome(str(input("Enter the path to chromedriver: ")))
    ...
    def like_photo(self):
        bot = self.bot
        bot.get(str('https://www.instagram.com/explore/tags/'+ str(input("enter hashtag: "))))#change the word bitcoin here , to whatever hashtag you want
        time.sleep(5)
...
go = InstaBot(str(input("Enter username: "))  ,str(input("Enter password: "))) #change the username and password here 
go.Login()
go.like_photo()